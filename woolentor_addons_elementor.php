 ...
 * Plugin URI: 	http://demo.wphash.com/woolentor/
 * Version: 	1.2.1
 * Author: 		HasThemes
...
define( 'WOOLENTOR_VERSION', '1.2.1' );
define( 'WOOLENTOR_ADDONS_PL_URL', plugins_url( '/', __FILE__ ) );
define( 'WOOLENTOR_ADDONS_PL_PATH', plugin_dir_path( __FILE__ ) );
...
function woolentor_pl_setting_links( $links ) {
    ...
    $go_pro_link = sprintf('<a href="https://hasthemes.com/plugins/woolentor-pro/" target="_blank" style="color: #39b54a; font-weight: bold;">' . esc_html__('Go Pro','woolentor') . '</a>');
    if( !is_plugin_active('woolentor-addons-pro/woolentor_addons_pro.php') ){
        array_unshift( $links, $woolentor_settings_link, $go_pro_link );
    }else{
